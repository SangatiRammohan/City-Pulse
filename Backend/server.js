...
const allowedOrigins = [
  ...
  'https://city-pulse-backend-w59a.onrender.com' // Add your deployed frontend URL in environment variables
...
if (process.env.NODE_ENV === 'production') {
  // Trust proxy for Render.com/Heroku
...
// Catch all for non-API routes (important for SPA if frontend is served here)
app.use((req, res) => {
  res.status(404).json({
    status: 'error',
    message: 'Route not found',
...
app.listen(PORT, '0.0.0.0', () => {
  ...
  console.log(`📧 Email service: ${EMAIL_CONFIGURED ? `✅ Configured (${process.env.EMAIL_USER})` : '⚠️  Not configured'}`);
  console.log(`🔐 CORS Origins: ${allowedOrigins.filter(o => o).length} configured`);
  console.log('\n📍 Available Endpoints:');
