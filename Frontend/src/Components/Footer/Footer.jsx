        ...
        <div className="footer-section newsletter-section">
          ...
          <div style={{ marginBottom: '1.5rem' }}>
            <div className="contact-info">
              ...
              <a href="tel:+8888888888" className="contact-link">+91 (888) 888-8888</a>
            </div>
            <div className="contact-info">
              <FaEnvelope className="contact-icon" />
              <a href="mailto:citypulsetours01@gmail.com" className="contact-link">citypulsetours01@gmail.com</a>
            </div>
          </div>
